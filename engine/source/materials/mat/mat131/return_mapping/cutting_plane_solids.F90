...
!----------------------------------------------------------------
        ...
        real(kind=WP), dimension(nel) :: pla0,normxx,normyy,normzz,normxy,     &
          normyz,normzx,phi,young,dsigy_dpla,dtemp_dpla,s13,s23,shf,           &
          sigbxx,sigbyy,sigbzz,sigbxy,sigbyz,sigbzx,sigy0,dsigy0_dpla,         &
          dtemp0_dpla,zeros,dsigxx_dlam,dsigyy_dlam,dsigzz_dlam,dsigxy_dlam,   &
          dsigyz_dlam,dsigzx_dlam,dpla_dlam,dlam,dseq_dlam,                    &
